...
void chain_rule_sub(struct Variable *root, struct Variable *left, struct Variable *right);
...
void chain_rule_exp(struct Variable *root, struct Variable *left, struct Variable *right);
